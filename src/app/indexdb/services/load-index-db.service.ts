...
export class LoadIndexDBService {
  ...
  `;
    ...
    const response = await firstValueFrom(
      this.graphql.query<{ getPersonas: PersonasDB[] }>(query),
    );
  ...
  async loadPersonasSedes(): Promise<void> {
    ...
    const response = await firstValueFrom(
      this.graphql.query<{ getPersonasSedes: Personas_sedesDB[] }>(query),
    );
  ...
  `;
    ...
    const response = await firstValueFrom(
      this.graphql.query<{ getSesionesSedes: SesionesDB[] }>(query, variables),
    );
